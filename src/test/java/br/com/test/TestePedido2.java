...
public class TestePedido2 {
  ...
  @Test
  public void testEPedido2() throws Exception {
    ...
    new Select(driver.findElement(By.name("formPrato:j_idt5:0:j_idt8"))).selectByVisibleText("2");
    driver.findElement(By.id("formPrato:j_idt5:0:adicionarPrato")).click();
    driver.findElement(By.id("formPrato:j_idt5:2:adicionarPrato")).click();
    ...
    driver.findElement(By.id("formPedido:j_idt11:1")).click();
